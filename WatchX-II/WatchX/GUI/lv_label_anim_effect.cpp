...
void lv_label_anim_effect_init(lv_label_anim_effect_t* effect, lv_obj_t* cont, lv_obj_t* label_copy)
{
...
void lv_label_anim_effect_check_value(lv_label_anim_effect_t* effect, uint8_t value)
{
    /*如果值相等则不切换*/
