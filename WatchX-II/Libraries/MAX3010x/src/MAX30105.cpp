...
float MAX30105::readTemperatureF()
{
    ...
    if ((int)temp != -999) temp = temp * 1.8f + 32.0f;
...
//        _i2cPort->endTransmission();
        ...
        while (bytesLeftToRead > 0)
        {
            ...
            I2Cx_Read(SENSOR_I2C, MAX30105_ADDRESS, MAX30105_FIFODATA, buffer, toGet);
...
//    return (0); //Fail
    return I2Cx_ReadReg(SENSOR_I2C, address, reg);
}
...
//    _i2cPort->endTransmission();
    I2Cx_WriteReg(SENSOR_I2C, address, reg, value);
}
