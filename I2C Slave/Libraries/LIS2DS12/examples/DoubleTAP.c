...
#define  TAP_DURATION    2 // 1 LSb = 32 / ODR ( @400Hz -> 32/400 = 80 ms/LSb ) 
...
int example_main(void)
{
  ...
  /* Set Tap duration */
  LIS2DS12_ACC_W_WakeUpDuration(0, TAP_DURATION);
  ...
  /* TAP evaluation */
  LIS2DS12_ACC_W_SINGLE_DOUBLE_TAP(0, LIS2DS12_ACC_SINGLE_DOUBLE_TAP_EV_ON);
  
  /* Double Tap on INT1 */
  LIS2DS12_ACC_W_INT1_D_TAP(0, LIS2DS12_ACC_INT1_D_TAP_ON);
  LIS2DS12_ACC_W_INT1_S_TAP(0, LIS2DS12_ACC_INT1_S_TAP_OFF); 
  ...
  while(1)
  {
    //Polling on int pin driven by Double TAP interrupt signal 
